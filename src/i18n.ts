...
const STRINGS = {
	...
	"toolbar.search": { en: "Semantic search", ko: "시맨틱 검색" },
	"toolbar.searchAria": { en: "Toggle semantic search", ko: "시맨틱 검색 열기/닫기" },
	"search.placeholder": { en: "Search by meaning...", ko: "의미로 검색..." },
	"search.noResults": { en: "No results.", ko: "결과가 없습니다." },
	"search.searching": { en: "Searching...", ko: "검색 중..." },
	"search.failed": { en: "Search failed: {message}", ko: "검색 실패: {message}" },
